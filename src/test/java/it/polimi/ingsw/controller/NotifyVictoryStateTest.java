...
public class NotifyVictoryStateTest {
    ...
    void setUp() {
        ...
        InputStreamReader input2 = new InputStreamReader(new InputStream() {
            @Override
            public int read() throws IOException {
                return 0;
            }
        });
        view2.setIn(new Scanner(input2));
        view2.setSocket(socket2);
        view2.setInput(input2);
    ...
    void victoryTest() {
        ...
        InputStreamReader input3 = new InputStreamReader(new InputStream() {
            @Override
            public int read() throws IOException {
                return 0;
            }
        });
        view3.setIn(new Scanner(input3));
        view3.setSocket(socket3);
        view3.setInput(input3);
        view3.setOut(new PrintWriter(new BufferedWriter(new OutputStreamWriter(new OutputStream() {
            @Override
            public void write(int b) throws IOException {
        ...
        assertTrue(controller.getGame().getWinner().getUsername().equals("john"));
